...
<html lang="en">
  ...
  <meta name="request-id" content="9210:7F10:12739E:1B895F:5C442397" data-pjax-transient>
...
<meta class="js-ga-set" name="dimension1" content="Logged Out">
    ...
    <meta name="js-proxy-site-detection-payload" content="YjNjYWRjMTczYjgxZDFkYjkxZmYwNGMyODZmZjMzMzA2MjFhYjBiOGRkZTYyMzhmZWRiOWY4Njc2YTU0ZDZkOXx7InJlbW90ZV9hZGRyZXNzIjoiMTI0LjIwNy4zOC4yMjAiLCJyZXF1ZXN0X2lkIjoiOTIxMDo3RjEwOjEyNzM5RToxQjg5NUY6NUM0NDIzOTciLCJ0aW1lc3RhbXAiOjE1NDc5Njk0MzIsImhvc3QiOiJnaXRodWIuY29tIn0=">

    <meta name="enabled-features" content="UNIVERSE_BANNER,MARKETPLACE_PLAN_RESTRICTION_EDITOR">

  <meta name="html-safe-nonce" content="a156dc2d22d206c9c8cf6031c42e3f9efc45a872">
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="32967073" data-scoped-search-url="/teddysun/across/search" data-unscoped-search-url="/search" action="/teddysun/across/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
      <label class="form-control header-search-wrapper header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          aria-label="Search"
          data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations#csrf-token=O1HQzUsyfKth8jd5BB0BNduNM6k3iDhDv20MLcCZI7GamJuytrVbBEUc8LUQEeNyTg/soXzBpebiDJ3F4bFKHg=="
          spellcheck="false"
          autocomplete="off"
          >
...
<li class="d-flex flex-justify-start flex-items-center p-0 f5 navigation-item js-navigation-item js-jump-to-global-search d-none" role="option">
  <a tabindex="-1" class="no-underline d-flex flex-auto flex-items-center jump-to-suggestions-path js-jump-to-suggestion-path js-navigation-open p-2" href="">
    ...
    <div aria-hidden="true" class="border rounded-1 flex-shrink-0 bg-gray px-1 text-gray-light ml-1 f6 d-none d-on-nav-focus js-jump-to-badge-jump">
      ...
      <span class="d-inline-block ml-1 v-align-middle">↵</span>
        ...
        <a class="HeaderMenu-link no-underline mr-3" href="/login?return_to=%2Fteddysun%2Facross%2Fblob%2Fmaster%2Fbench.sh" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign&nbsp;in</a>
  ...
  <li>
    ...
    <a href="/teddysun/across/network/members" class="social-count"
       aria-label="948 users forked this repository">
      948
    </a>
  </li>
</ul>
...
<nav class="reponav js-repo-nav js-sidenav-container-pjax container"
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    ...
    <a class="js-selected-navigation-item reponav-item" data-selected-links="repo_graphs repo_contributors dependency_graph pulse alerts security people /teddysun/across/pulse" href="/teddysun/across/pulse">
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  <div class="repository-content ">
    ...
    <a class="d-none js-permalink-shortcut" data-hotkey="y" href="/teddysun/across/blob/f9c689512d3c56b545450cdd9ae89770d96f7eda/bench.sh">Permalink</a>
    ...
    <!-- blob contrib key: blob_contributors:v21:daf4fbf66decd4d2bbc37d0f9052ac20 -->
      ...
      <div class="signup-prompt p-4 text-center mb-4 rounded-1">
        <div class="position-relative">
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form action="/site/dismiss_signup_prompt" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="HfjdjOhhI84oSKNblUnaxJjeX82MLOU9cD3movyzHZu5U586Qv4g6IrWLFfnkPLX1sZn1MPTEdO7k1vixlNQ6g==" />
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left js-load-contents"
  data-contents-url="/teddysun/across/ref-list/master/bench.sh?source_action=show&amp;source_controller=blob">
  ...
  <div class="commit-tease">
      ...
      <div>
        ...
        <a class="user-mention" rel="author" data-hovercard-type="user" data-hovercard-url="/hovercards?user_id=1475030" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/teddysun">teddysun</a>
  ...
  <details class="details-reset details-overlay BlobToolbar position-absolute js-file-line-actions dropdown d-none" aria-hidden="true">
    ...
    <details-menu>
      <ul class="BlobToolbar-dropdown dropdown-menu dropdown-menu-se mt-2" style="width:185px">
        ...
        <li><a class="dropdown-item js-update-url-with-hash" id="js-view-git-blame" role="menuitem" href="/teddysun/across/blame/f9c689512d3c56b545450cdd9ae89770d96f7eda/bench.sh">View git blame</a></li>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2019 <span title="0.13892s from unicorn-66f7ff75dc-wv8fv">GitHub</span>, Inc.</li>
